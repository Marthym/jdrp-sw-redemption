...
\begin{dnditemtable}[ l c c c ]
    \textbf{Type} & \textbf{Débats} & \textbf{Poids} & \textbf{Prix} \\
...
\begin{dnditemtable}[ l c c c c ]
    \textbf{Type} & \textbf{Portée} & \textbf{Débats} & \textbf{Poids} & \textbf{Prix} \\
...
\begin{dnditemtable}[ l c c c c ]
    \textbf{Type} & \textbf{Porté} & \textbf{Dégâts} & \textbf{Prix} \\
