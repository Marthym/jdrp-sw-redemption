...
\begin{itemtable}[ X c c c ]
    ...
    Artificiel  & For+d6+8   & 2              & Parade +1, PA 4 \\
    Naturel     & For+d6+6   & 2              & Parade +3, PA 4
\end{itemtable}

\emph{PA (Pénétration d’armure)}: l’arme ou le projectile ignore les points d’armure indiqués. Une arme avec la capacité PA 4 ignore 4 points d’armure. Les points de PA supérieurs à la protection de la cible sont ignorés.\\

\emph{Malus Combat}: Le Sabre Laser est une arme dangereuse et difficile à manier. Seuls les utilisateurs de la Force sont capables d'en exploiter pleinement le potentiel. L'utilisation d'un Sabre Laser est soumise à un malus de \textbf{-4}, pour les Padawan/Apprenti le malus passe à \textbf{-2} et disparaît pour les Jedi/Sith
