...
\begin{description}[align=left]
    ...
    \item [Jar’Kai]
        \emph{[Shii-Cho]}\\
        Votre héros a été formé à l’art du combat au Sabre Laser (p. \pageref{sec:sabre-laser}). Il ne subit plus le malus de -2 lors de son utilisation et ne risque plus de se blesser lors d’un échec critique.
