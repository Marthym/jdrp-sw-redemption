...
\begin{description}[align=left]
    ...
    \item [Padawan]
        ...
        Votre héro peut alors apprendre, avec l'aide de son maître, à utiliserles \emph{Pouvoirs \'Elémentaires} et \emph{Pouvoirs Universels}. Voir la section sur La Force~\ref{sec:force} (p. \pageref{sec:force}).

    \item [Apprenti Sith]
        \emph{[Aguerri, \^Ame d10+, Arcane (Force)]}\\
        La haine et la rancoeur de votre héro ont donné des idées à un Seigneur Sith qui decide de le prendre comme apprenti.

        Votre héro peut alors apprendre, avec l'aide de son maître, à utiliser les \emph{Pouvoirs \'Elémentaires} et \emph{Pouvoirs Universels}. Voir la section sur La Force~\ref{sec:force} (p. \pageref{sec:force}).
    ...
    \item [Maître Jedi]
        ...
        Le Maître Jedi a accès à tout les \emph{Pouvoirs du coté Lumineux}. Voir la section sur La Force~\ref{sec:force} (p. \pageref{sec:force})
    ...
    \item [Seigneur Sith]
        ...
        Il bénéficit en plus de conseil de son maître.
...
\begin{paperbox}{\'Equilibrage Jedi / Sith}
Concernant les atouts Maître Jedi et Seigneur Sith, les pouvoirs Sith sont un peu plus avantageux que les pouvoir Jedi car :
\begin{quote}
Plus facile, plus rapide, plus séduisant est le côté obscur ; mais pas plus fort, il est.
\end{quote}

Et dans un souci d'équilibre, les Jedis bénéficient du soutient de leur ordre. Cela implique beaucoup de connaissance, d'allié et d'informations. Contrairement aux Sith qui eux bénéficient des conseil de leur Maître. Le MJ doit tenir compte de la nature des Sith, de leur coté solitaire et égoïste des Siths.
\end{paperbox}
